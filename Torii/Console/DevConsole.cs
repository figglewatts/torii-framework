...
namespace Torii.Console
{
    public static class DevConsole
    {
        ...
        public static void Deregister(object obj) { Deregister(obj.GetType()); }

        public static void Deregister(Type t) { _registered.Remove(t.Name); }
        ...
        private static ExecutionResult applyStatementToObjectField(ParsedStatement statement,
            ObjectInfo obj,
            FieldInfo field)
        {
        ...
        private class ObjectInfo
        {
            ...
            private bool typeIsAllowed(Type t) { return ALLOWED_TYPES.Contains(t); }
        }
    }
}
