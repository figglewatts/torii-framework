...
namespace Torii.Resource
{
    ...
    public static class ResourceManager
    {
        ...
        /// </summary>
        public static void ClearUnusedUnityAssets() { Resources.UnloadUnusedAssets(); }
        ...
        public static T Load<T>(string path) { return Load<T>(path, _lifespans["global"]); }
        ...
        /// <returns>The loaded resource.</returns>
        /// <exception cref="ArgumentException">If the lifespan didn't exist.</exception>
        public static T Load<T>(string path, string span) { return Load<T>(path, _lifespans[span]); }
        ...
        /// <typeparam name="T">The type of the resource.</typeparam>
        /// <returns>The loaded resource.</returns>
        public static T UnityLoad<T>(string path) where T : class { return UnityLoad<T>(path, _lifespans["global"]); }
        ...
        public static void RegisterResource(string path, GenericResource r) { _resources[path] = r; }

        /// <summary>
        /// Register a new resource handler.
        /// </summary>
        /// <param name="handler">An instance of the handler.</param>
        public static void RegisterHandler(IResourceHandler handler) { _handlers[handler.HandlerType] = handler; }
